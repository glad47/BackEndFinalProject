...
public class GenSerialUtil {
    private static final int FLAG_BIT_LEN = 10;
    private static final String Base32Alphabet = "A23D4U65EQRSVWMX7C8FBGHJKNP9TYZL";
//    private static final String Base32Alphabet = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789";
    ...
    public static Long getFlagFromCode(String code){
        long id = convertBase32CharToNum(code);
        return id >> (code.length()*5-FLAG_BIT_LEN);
    }
     ...
     * @return
     */
    public static String generateCode(int flag){
        return generateNewCode(flag,FLAG_BIT_LEN);
    }
...
//
//        String s = generateNewCode(3);
//        System.out.println(s);
//
//        String code = generateNewCode(4,FLAG_BIT_LEN);
//        System.out.println("序列号: "+code);
//        boolean checkRs = checkCodeValid(code);
//        System.out.println("序列号" + code + "是否合法：" + checkRs);
//        long acId = getFlagFromCode(code,FLAG_BIT_LEN);
//        System.out.println("标识: " + acId);
//        long numCode = convertBase32CharToNum(code);
//        System.out.println("数字序列号 " + numCode);
//
